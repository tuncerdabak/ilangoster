...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-8">
                <a href="android_uygulama/ilangoster_v2.apk"
                    class="block w-full py-4 px-6 bg-green-600 hover:bg-green-700 text-white text-center font-bold rounded-2xl shadow-lg transition transform hover:-translate-y-1 mb-8 text-lg">
                    Hemen İndir (v2 .APK)
                </a>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        <div
                            class="bg-green-100 text-green-600 rounded-full h-8 w-8 flex items-center justify-center flex-shrink-0 font-bold">
                            1</div>
                        <div>
                            <p class="font-bold text-gray-800">APK Dosyasını İndirin</p>
                            <p class="text-sm text-gray-600">Yukarıdaki butona tıklayarak dosyayı telefonunuza kaydedin.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">İndirme tamamlandığında bildirim panelinden veya
                                "Dosyalarım" klasöründen dosyayı açın.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Eğer "Bilinmeyen Kaynaklar" uyarısı alırsanız, ayarlar
                                kısmından bu tarayıcıya izin verin.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-10 p-4 bg-yellow-50 rounded-xl border border-yellow-100">
                    <p class="text-xs text-yellow-800 leading-relaxed text-center">
                        <strong>Not:</strong> Uygulamamız henüz Google Play Store'da onay aşamasındadır. Bu nedenle
                        "Bilinmeyen Kaynak" uyarısı almanız normaldir, güvenle kurabilirsiniz.
                    </p>
                </div>
            </div>
        </div>
