...
<body class="bg-gray-100 min-h-screen font-sans">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="admin.php?logout=true" class="text-red-600 hover:text-red-800 text-sm font-medium">Çıkış
                        Yap</a>
                </div>
            </div>
        </div>
                        ...
                        <li class="px-4 py-4 sm:px-6 hover:bg-gray-50 transition">
                            ...
                            <div class="ml-4 flex items-center space-x-3">
                                ...
                                <button onclick="openShareModal(<?= $g['id'] ?>, '<?= $g['unique_token'] ?>')"
                                    class="bg-green-100 text-green-700 hover:bg-green-200 px-3 py-1 rounded-full text-sm font-bold flex items-center gap-1 transition">
                                ...
                                <a href="g/<?= $g['unique_token'] ?>" target="_blank"
                                    class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">Görüntüle</a>
                                <form method="POST" onsubmit="return confirm('Bu galeriyi silmek istediğinize emin misiniz?');">
                                    <input type="hidden" name="gallery_id" value="<?= $g['id'] ?>">
                                    <button type="submit" name="delete_gallery"
                                        class="text-red-500 hover:text-red-700 text-sm font-bold">Sil</button>
                                </form>
                            </div>
                </div>
                </li>
    ...
    <div id="shareModal"
        ...
        <div
            ...
            <h3 class="text-xl font-bold text-gray-800 mb-4 text-center">WhatsApp ile Paylaş</h3>
            <p class="text-sm text-gray-500 mb-6 text-center">İlanı göndermek istediğiniz müşterinin numarasını giriniz.
            </p>

            <div class="space-y-4">
                <input type="hidden" id="modalGalleryId">
                <div>
                    <label class="block text-xs font-semibold text-gray-600 uppercase mb-1">Müşteri Numarası</label>
                ...
                <button onclick="submitShare()" id="btnShareSubmit"
                    class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg flex justify-center items-center gap-2 transition">
